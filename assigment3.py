...
personality = st.sidebar.selectbox(
    ...
    ["crazy ronaldo fan", "Intelligent jarvis", "Mad Dr. Strange", "Captain America", "Iron Man", "powerful Thor"]
)
...
if user_msg := st.chat_input("Say something"):
        ai_instruction = f"You are acting as {personality} with an intensity level {intensity}. Respond to the message sent by user staying completely in character."
